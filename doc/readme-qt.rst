...
Alternatively, install `Qt Creator`_ and open the `gamecoin-qt.pro` file.
...
The static binary version of GameCoin is linked against libdb4.8 (see also `this Debian issue`_).
