...
void BitcoinGUI::createActions()
{
    ...
    aboutAction->setStatusTip(tr("Show information about GameCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GameCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gamecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gamecoin addresses"));
