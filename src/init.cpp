...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Parameters
        //
        // If Qt is used, parameters/gamecoin.conf are parsed in qt/bitcoin.cpp's main()
        ...
        {
            // First part of help message is specific to GameCoin server / RPC client
            std::string strUsage = _("GameCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  gamecoin [options]                     " + "\n" +
                  "  gamecoin [options] <command> [params]  " + _("Send command to -server or gamecoin") + "\n" +
                  "  gamecoin [options] help                " + _("List commands") + "\n" +
                  "  gamecoin [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: gamecoin.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 11067 or testnet: 143605)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 21067)") + "\n" +
