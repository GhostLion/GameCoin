...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 11067 or testnet: 146)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 22067 or testnet: 0542)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Gamecoin Wiki for SSL setup instructions)") + "\n" +
