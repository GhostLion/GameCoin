...
int64_t GetProofOfWorkReward(unsigned int nBits, int64_t nFees)
{
    ...
    // GameCoin: subsidy is cut in half every 64x multiply of PoW difficulty
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, unsigned int nBits, unsigned int nTime, bool bCoinYearOnly)
{
    ...
    if(fTestNet || nTime > STAKE_SWITCH_TIME)
    {
        ...
        // GameCoin: A reasonably continuous curve is used to avoid shock to market
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("gamecoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in GameCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // GameCoin: check proof-of-stake block signature
...
// gamecoin: attempt to generate suitable proof-of-stake
