...
uint256 hashGenesisBlock("0x36c111ff46992c0e1cfe23272125c65483d4f123899524ed7072e01260293b8d");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 14360542);
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 120; // GameCoin: 0.35 days
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal gamecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GameCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x36c111ff46992c0e1cfe23272125c65483d4f123899524ed7072e01260293b8d");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1421792414;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088880219;
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // GameCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
