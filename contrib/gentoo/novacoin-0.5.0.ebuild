...
src_install() {
	...
	newins "src/qt/res/icons/gamecoin-128.png" "${PN}.png"

	make_desktop_entry "${PN}-qt" "Gamecoin" "/usr/share/pixmaps/${PN}.png" "Network;P2P;Finance;"

	if use kde; then
		insinto /usr/share/kde4/services
		newins contrib/debian/gamecoin-qt.protocol ${PN}.protocol
	fi
}
